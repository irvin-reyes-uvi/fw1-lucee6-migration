...
<cfparam name="attributes.tablehead_bgcolor" default="cccccc">
<cfparam name="attributes.body_bgcolor" default="E6E6E6">
<!--- *********************************************************	--->
...
<CFELSEIF DisplayError>
	<cfoutput><div class="error" align="center">#session.errorMessage#</div></cfoutput>
          ...
          <table width="<cfoutput>#attributes.width#</cfoutput>" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
            <tr>
              <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td bgcolor="<cfoutput>#attributes.tablehead_bgcolor#</cfoutput>" class="tablehead">Please complete the form below</td>
                  </tr>
                  <tr>
                    <td bgcolor="<cfoutput>#attributes.body_bgcolor#</cfoutput>"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr> 
                  ...
                  <CFIF ATTRIBUTES.Form_Type IS "ETS" or Attributes.form_type is "ETS_COBRAND">
                    ...
                    <cfif attributes.form_type is not "ETS_COBRAND">
                      <tr> 
                        ...
                        <td><select name="department_id" class="bookinglongDrop" id="department_id" >
							...
							<cfif findnocase("negrilgardens",cgi.HTTP_HOST)>
							  <cfif not findnocase("signature", dep_name)>
                    ...
                    <tr > 
					  ...
					  <cfoutput>
                        ...
                        <br> <textarea name="message" cols="25" rows="8" wrap="VIRTUAL"  class="textbox" id="message" onKeyDown="textCounter(this.form.message,this.form.remLentext,4000);" 
...
<option value="Evening">Evening</option>
                  ...
                  <tr> 
                    <td colspan="2"><div align="center" class="bluelinknopad"><a href="http://www.sandals.com/general/legal.cfm" class="bluelinknopad"> 
