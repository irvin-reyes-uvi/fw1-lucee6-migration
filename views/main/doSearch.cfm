                                                                ...
                                                                <td align="left" valign="top">
                                                                    <table width="400"  border="0" align="center" cellpadding="0" cellspacing="0" class="backgroundEEE">
                                                                        ...
                                                                        <tr bgcolor="EFEFEF">
                                                                            ...
                                                                            <td  class="tablecell heightCell">
                                                                                <cfif cgi.SERVER_NAME contains "local">
                                                                                    <input type="text" name="CCFirstName" id="CCFirstName" class="textbox stWidth145" size="14" value="" maxlength="20" ></td>
                                                                                <cfelse>
                                                                        ...
                                                                        <tr bgcolor="EFEFEF">
                                                                            ...
                                                                            <td  class="tablecell heightCell">
                                                                                <cfif cgi.SERVER_NAME contains "local">
                                                                                    <input type="text" name="CCLastName" id="CCLastName" class="textbox stWidth145" size="14" value="" maxlength="20" ></td>
                                                                                <cfelse>
